...
export function PhotoStrip({photos,frame,layout=layoutById('classic'),filter,transforms,active,onSelect,message='',showDate=true,date=new Date(),typography=typographyById(defaultTypographyId),alignment='center',textSize=defaultTextSize}:{photos:Photo[];frame:Frame;layout?:LayoutPreset;filter:PhotoFilter;transforms:Record<string,PhotoTransform>;active?:string;onSelect?:(id:string)=>void;message?:string;showDate?:boolean;date?:Date;typography?:TypographyPreset;alignment?:TextAlignment;textSize?:TextSize}){
